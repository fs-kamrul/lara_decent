...
{{--                    </div>--}}
        ...
        <div class="row">
            ...
            {!! Theme::partial('admin_board.admin_ftpserver.items', ['admin_ftpservers' => $admin_ftpservers, 'img_slider' => true]) !!}

            <div class="justify-content-center">
                @if ($admin_ftpservers->total() > 0)
                    {!! $admin_ftpservers->links(Theme::getThemeNamespace() . '::partials.admin_board.pagination') !!}
                @endif
            </div>
