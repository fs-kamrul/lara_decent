...
namespace Theme\CorporateTheme\Http\Controllers;
...
use Theme\CorporateTheme\Http\Resources\PostResource;
use Theme\CorporateTheme\Http\Resources\ProductCategoryResource;
use Theme\CorporateTheme\Http\Resources\BrandResource;
use Theme\CorporateTheme\Http\Resources\ReviewResource;
use Theme;
use Cart;
use EcommerceHelper;

class CorporateThemeController extends PublicController
{
    /**
