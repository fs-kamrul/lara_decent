<!-- ----------------------- Different Start ----------------------- -->
@if($packages)
    <div class="tp-price__area pt-95">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="tp-price__title-box text-center">
                        <div class="tp-section-subtitle-box">
                            <span class="tp-section-subtitle section-subtitle-border"> {!! $shortcode->tag_line !!}</span>
                        </div>
                        <h3 class="tp-section-title">
{{--                            <img src="{{ asset('themes/' . Theme::getPublicThemeName() . '/img/package/badge-icon.png') }}" alt="">--}}
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 mb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="{{ $wow +=$increment }}s">
                    <div class="tp-price__item active p-relative text-center">
                        ...
                        <div class="tp-price__head">
                            <h4 class="tp-price__title">{{ $package->name }}</h4>
{{--                            <span>Save 20%</span>--}}
                        </div>
                        ...
                        <div class="tp-price__content-wrap">
                            <div class="tp-price__feature">
                                <ul>
                                    @foreach($package->admin_facilities as $facility)
                                        <li>{{ $facility->name }}</li>
                                    @endforeach
                                </ul>
                            </div>
                            <div class="tp-price__info-box">
                                <h4 class="p-relative">
                                    {{ $package->price }} Tk/{{ $package->price_map }}
                                    <span>
...
{{--                                <span>Installation Charge: 1,500 Tk</span>--}}
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="tp-service__bottom-text text-center mt-60 mb-60">
                        <span> <a href="{{ url('packages') }}"> View More Packages</a><em><i class="fa-light fa-plus"></i></em></span>
                    </div>
                </div>
            </div>
        </div>
