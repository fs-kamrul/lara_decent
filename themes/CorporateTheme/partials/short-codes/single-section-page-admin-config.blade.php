...
<div class="form-group">
    ...
    <input name="header" value="{{ Arr::get($attributes, 'header') }}" class="form-control" />
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    {!! Form::customSelect('section_type', get_rl_type_layouts(), Arr::get($attributes, 'section_type'), ['class' => 'form-control', 'id' => 'section_type']) !!}
</div>
