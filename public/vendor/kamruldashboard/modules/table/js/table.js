(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: dt => {
            return '<i class="far fa-file-excel"></i> ' + dt.i18n('buttons.excel', KamrulVariables.languages.tables.excel ? KamrulVariables.languages.tables.excel : 'Excel');
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: dt => {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', KamrulVariables.languages.tables.export ? KamrulVariables.languages.tables.export : 'Export') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: dt => {
            return '<i class="fas fa-file-csv"></i> ' + dt.i18n('buttons.csv', KamrulVariables.languages.tables.csv ? KamrulVariables.languages.tables.csv : 'CSV');
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: dt => {
            return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', KamrulVariables.languages.tables.print ? KamrulVariables.languages.tables.print : 'Print');
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: dt => {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', KamrulVariables.languages.tables.reset ? KamrulVariables.languages.tables.reset : 'Reset');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: dt => {
            return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', KamrulVariables.languages.tables.reload ? KamrulVariables.languages.tables.reload : 'Reload');
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', event => {
                ...
                if (ids.length === 0) {
                    kamruldashboard.showError(KamrulVariables.languages.tables.please_select_record ? KamrulVariables.languages.tables.please_select_record : 'Please select at least one record to perform this action!');
                    return false;
                }
        ...
        loadBulkChangeData($element) {
            ...
            $.ajax({
                ...
                success: res => {
                    ...
                    kamruldashboard.initResources();
                },
                error: error => {
                    kamruldashboard.handleError(error);
                }
            });
        }
