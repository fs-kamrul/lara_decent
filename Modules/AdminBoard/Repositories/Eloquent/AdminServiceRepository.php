...
class AdminServiceRepository extends RepositoriesAbstract implements AdminServiceInterface
{

    public function getAdminServiceGroup($filters = [], $params = [])
    {
        $filters = array_merge([
            'keyword' => null,
            'min_floor' => null,
        ...
        $this->model = apply_filters('AdminService_filter_query', $this->model, $filters, $params);

        return $this->advancedGet($params);
    }
     public function getAdminService($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
     ...
     public function getRelatedAdminService(int $projectId, int $limit = 4, array $with = [])
     {
