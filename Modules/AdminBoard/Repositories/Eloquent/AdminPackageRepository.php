...
class AdminPackageRepository extends RepositoriesAbstract implements AdminPackageInterface
{
    public function getAdminPackageGroup($filters = [], $params = [])
    {
        $filters = array_merge([
            'keyword' => null,
            'min_floor' => null,
        ...
        $this->model = apply_filters('AdminPackage_filter_query', $this->model, $filters, $params);

        return $this->advancedGet($params);
    }
     public function getAdminPackage($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
     ...
     public function getRelatedAdminPackage(int $projectId, int $limit = 4, array $with = [])
     {
