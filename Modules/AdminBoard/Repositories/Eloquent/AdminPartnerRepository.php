...
class AdminPartnerRepository extends RepositoriesAbstract implements AdminPartnerInterface
{
     public function getAdminPartner($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
         ...
         $this->model = apply_filters('AdminPartner_filter_query', $this->model, $filters, $params);

         return $this->advancedGet($params);
     }

     public function getRelatedAdminPartner(int $projectId, int $limit = 4, array $with = [])
     {
