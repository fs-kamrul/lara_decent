...
class AdminFtpServerRepository extends RepositoriesAbstract implements AdminFtpServerInterface
{
     public function getAdminFtpServer($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
     ...
     public function getRelatedAdminFtpServer(int $projectId, int $limit = 4, array $with = [])
     {
