...
class AdminTeamRepository extends RepositoriesAbstract implements AdminTeamInterface
{
     public function getAdminTeam($filters = [], $params = [])
     {
         $filters = array_merge([
             'keyword' => null,
             'min_floor' => null,
         ...
         $this->model = apply_filters('AdminTeam_filter_query', $this->model, $filters, $params);

         return $this->advancedGet($params);
     }

     public function getRelatedAdminTeam(int $projectId, int $limit = 4, array $with = [])
     {
