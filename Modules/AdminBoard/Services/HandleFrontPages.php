...
//                        dd($image['id']);
                ...
                $Newses_post = AdminBoardHelper::getNewsFilter(7, []);
...
//                        dd($image['id']);
                ...
                $events_post = AdminBoardHelper::getEventFilter(7, []);
